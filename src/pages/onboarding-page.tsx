      ...
      {step === 1 ? (
        <label className="block space-y-2">
          ...
          <input
            ...
            className={cn(uiLayoutStyles.input, "disabled:opacity-50")}
          />
          <button type="button" onClick={() => setPeriodUnknown((value) => !value)} className={helperButtonClass}>
      ...
      {step === 2 ? (
        <label className="block space-y-2">
          ...
          <input
            ...
            className={cn(uiLayoutStyles.input, "disabled:opacity-50")}
          />
          <button type="button" onClick={() => setCycleUnknown((value) => !value)} className={helperButtonClass}>
